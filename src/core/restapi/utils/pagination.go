...
func applyMapSlicePagination(items []map[string]interface{}, page, limit int) ([]map[string]interface{}, *models.PaginationInfo) {
	totalCount := len(items)
	offset := GetOffset(page, limit)
...
func (h *PaginationHelper) CreateResponse(items interface{}, totalCount int, params models.PaginationParams, requestID string) *models.PaginatedResponse {
...
func FilterAndPaginate(items []map[string]interface{}, filters map[string]interface{}, page, limit int) ([]map[string]interface{}, *models.PaginationInfo) {
	// Apply filters
