...
func (ebge *EventBasedGatewayExecutor) createCompetingEventSubscriptions(token *models.Token, outgoingFlows []string, element map[string]interface{}) ([]EventSubscription, error) {
...
func (ebge *EventBasedGatewayExecutor) analyzeFlowForEventSubscription(flowID string, token *models.Token, element map[string]interface{}) (*EventSubscription, error) {
...
func (ebge *EventBasedGatewayExecutor) getFlowTargetElement(flowID string, element map[string]interface{}) (string, error) {
...
func (ebge *EventBasedGatewayExecutor) analyzeElementForEventType(elementID string) (eventType string, eventDetails string) {
...
func (ebge *EventBasedGatewayExecutor) createEventSubscription(subscription EventSubscription, token *models.Token) error {
...
func (ebge *EventBasedGatewayExecutor) createTimerSubscription(subscription EventSubscription, token *models.Token) error {
...
func (ebge *EventBasedGatewayExecutor) createMessageSubscription(subscription EventSubscription, token *models.Token) error {
	if ebge.processComponent == nil {
...
func (ebge *EventBasedGatewayExecutor) createSignalSubscription(subscription EventSubscription, token *models.Token) error {
	if ebge.processComponent == nil {
