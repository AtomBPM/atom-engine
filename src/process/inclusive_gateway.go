...
func (ige *InclusiveGatewayExecutor) evaluateInclusiveGatewayConditions(outgoingFlows []string, token *models.Token, element map[string]interface{}) []string {
...
func (ige *InclusiveGatewayExecutor) evaluateFlowCondition(flowID string, variables map[string]interface{}, element map[string]interface{}) (hasCondition bool, result bool) {
...
func (ige *InclusiveGatewayExecutor) evaluateConditionWithExpressionEngine(condition string, variables map[string]interface{}) bool {
